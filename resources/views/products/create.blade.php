            ...
            <div class="mb-6 bg-vet-light-card dark:bg-vet-dark-card rounded-lg shadow-vet p-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <i class="fas fa-box-open text-2xl text-vet-primary-500 mr-3"></i>
                        <h2 class="text-xl font-bold text-vet-light-text-primary dark:text-white">Add New Product</h2>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3" 
                                      class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 shadow-sm focus:border-vet-primary-500 focus:ring-vet-primary-500">{{ old('description') }}</textarea>
                        </div>
