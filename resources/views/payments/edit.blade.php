                ...
                <div class="p-8">
                    <form action="{{ route('payments.update', $payment) }}" method="POST" class="space-y-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        ...
                                        <input type="number" name="amount" id="amount" step="0.01" required value="{{ $payment->amount }}" class="pl-7 mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 focus:border-emerald-500 focus:ring-emerald-500" placeholder="0.00">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="date" name="payment_date" id="payment_date" required value="{{ $payment->payment_date->format('Y-m-d') }}" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 focus:border-emerald-500 focus:ring-emerald-500">
                                </div>
                                ...
                                <div class="col-span-2">
                                    ...
                                    <textarea name="notes" id="notes" rows="3" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 focus:border-emerald-500 focus:ring-emerald-500" placeholder="Enter any additional payment details or notes">{{ $payment->notes }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-end space-x-3">
                            <a href="{{ route('payments.show', $payment) }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-md transition duration-300 ease-in-out">
                                Cancel
                            </a>
