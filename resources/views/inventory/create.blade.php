        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="mb-6 bg-vet-light-card dark:bg-vet-dark-card rounded-lg shadow-vet p-4">
                <div class="flex items-center">
                    ...
                    <h2 class="text-xl font-bold text-vet-light-text-primary dark:text-white">Add Inventory Stock</h2>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <textarea name="notes" id="notes" rows="3" 
                                      class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 shadow-sm focus:border-vet-primary-500 focus:ring-vet-primary-500"></textarea>
                        </div>
                    </div>
